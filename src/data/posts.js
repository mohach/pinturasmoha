export const posts = [
  {
    ...
    date: "Enero 2025",
    readTime: "6 min",
    // David Pisnoy — 4 paint rollers in orange, green, blue, red colours
    img: "https://images.unsplash.com/photo-1526040652367-ac003a0475fe?w=900&h=500&q=80&fit=crop&auto=format",
    imgAlt: "Rodillos de pintura de colores — muestras de color para paredes",
    body: `<h2>El color lo cambia todo</h2>
...
<div class="art-tip"><strong>Consejo final:</strong> Si te da miedo un color atrevido, prueba primero con una pared de acento. Si convence, extiendes. Si no, solo has pintado una pared.</div>`,
  },
  {
    ...
    date: "Febrero 2025",
    readTime: "7 min",
    // Theme Photos — paint roller applying blue paint on white wall (verified free)
    img: "https://images.unsplash.com/photo-1562259920-8e99e3b3cc93?w=900&h=500&q=80&fit=crop&auto=format",
    imgAlt: "Pintor alisando y pintando pared — eliminación de gotelé",
    body: `<h2>El gotelé: el gran enemigo del hogar moderno</h2>
...
<p><strong>6. Imprimación y pintura.</strong> Selladora antes de pintar para adhesión uniforme.</p>`,
  },
  {
    ...
    date: "Marzo 2025",
    readTime: "5 min",
    // Ernys — man painting exterior wall with roller (verified free, June 2024)
    img: "https://images.unsplash.com/photo-1718469344483-e3d1e9b9b9ea?w=900&h=500&q=80&fit=crop&auto=format",
    imgAlt: "Pintor pintando fachada exterior de una casa",
    body: `<h2>Pintar en exterior no es como pintar dentro</h2>
...
<div class="art-tip"><strong>Consejo:</strong> Revisa el parte meteorológico varios días antes. En Valencia el tiempo puede cambiar rápidamente.</div>`,
  },
  {
    ...
    date: "Abril 2025",
    readTime: "5 min",
    // Jacob Campbell — shelves of paint cans in hardware store (verified free)
    img: "https://images.unsplash.com/photo-1542621334-a254cf47733d?w=900&h=500&q=80&fit=crop&auto=format",
    imgAlt: "Estantería con botes de pintura en ferretería profesional",
    body: `<h2>La jungla de las pinturas</h2>
...
<p>Muy resistente pero acusa todas las imperfecciones. Solo para puertas, marcos y rodapiés.</p>`,
  },
  {
    ...
    date: "Mayo 2025",
    readTime: "6 min",
    // Loewe Technology — modern living room with green walls and white sofa (verified free)
    img: "https://images.unsplash.com/photo-1679066534282-4a2e25fb4bc8?w=900&h=500&q=80&fit=crop&auto=format",
    imgAlt: "Salón moderno con paredes verdes y sofá blanco",
    body: `<h2>El color como protagonista</h2>
...
<p>Empieza con una pared de acento. Observa durante una semana. Si convence, extiendes. Si no, solo has pintado una pared.</p>`,
  },
  {
    ...
    date: "Junio 2025",
    readTime: "5 min",
    // Andrew Itaga — person using paint roller on wall (verified free, Sep 2023)
    img: "https://images.unsplash.com/photo-1694183665800-4cb3e60e4d25?w=900&h=500&q=80&fit=crop&auto=format",
    imgAlt: "Persona pintando pared con rodillo — errores comunes al pintar",
    body: `<h2>Pintar parece fácil… hasta que no lo es</h2>
